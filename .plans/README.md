...
| 4 | [Inbox Concept](./inbox-concept/overview.md) | `inbox-concept/` | in-progress | Introduce Inbox entity so licensees can operate multiple WhatsApp numbers and chat instances; departments link to messenger inboxes — 4 phases, 7 tasks |
