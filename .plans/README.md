...
|---|------|--------|--------|-------------|
| 1 | [Decouple MongoDB](./decouple-mongo/overview.md) | `decouple-mongo/` | Complete | Complete the repository pattern: missing repos, `*RepositoryMemory` implementations, eliminate direct `.save()` calls and model imports from services/plugins/controllers |
