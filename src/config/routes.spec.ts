...
jest.mock('../app/routes/login-route', () => ({
  router: jest.fn(),
}))

jest.mock('../app/routes/resources-routes', () => jest.fn())
jest.mock('../app/routes/api-routes', () => jest.fn())
jest.mock('../app/routes/bull-board-route', () => jest.fn())
