  ...
  describe('validations', () => {
    describe('number', () => {
      it('is required', async () => {
        ...
        const validation = await message.validate().catch((e: any) => e)
    ...
    describe('text', () => {
      it('is required if kind is text', async () => {
      ...
      it('is not required if kind is not text', async () => {
    ...
    describe('url', () => {
      it('is required if kind is file', async () => {
        const message = new Message({ number: '87216', kind: 'file' })
        const validation = await message.validate().catch((e: any) => e)
      ...
      it('is not required if kind is not file', async () => {
        const message = new Message({ number: '87216', kind: 'text' })
        const validation = await message.validate().catch((e: any) => e)
    ...
    describe('kind', () => {
      it('accepts "text", "file" and "location" values', async () => {
        let validation
        const message = new Message()

        message.kind = 'text'
        validation = await message.validate().catch((e: any) => e)
    ...
    describe('destination', () => {
      ...
      it('accepts "to-chatbot", "to-chat", "to-messenger" and "to-transfer" values', async () => {
        let validation
        const message = new Message()
