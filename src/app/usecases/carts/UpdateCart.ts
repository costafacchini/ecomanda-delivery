...
function pickCartFields(fields: Record<string, any> = {}) {
  return PERMITTED_CART_FIELDS.reduce((payload: Record<string, any>, key) => {
...
class UpdateCart {
  ...
  async execute({ contactNumber, licenseeId, fields }: Record<string, any> = {}) {
