...
describe('Go2goV2 plugin', () => {
  ...
  describe('#transformCart', () => {
    it('returns the cart transformed in plugin format', async () => {
      ...
      expect(cartTransformed.order.subTotal).toEqual(17.8)
      ...
      expect(cartTransformed.order.totalPedido).toEqual(21.3)
      ...
      expect(cartTransformed.order.valorPagar).toEqual(21.3)
      ...
      expect(cartTransformed.order.pagamentos[0].valor).toEqual(21.3)
