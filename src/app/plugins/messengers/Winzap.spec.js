    ...
    describe('when the message was sent', () => {
      ...
      it('logs the success message', async () => {
        ...
        expect(consoleInfoSpy).toHaveBeenCalledWith(
          'Mensagem 60958703f415ed4008748637 enviada para Winzap com sucesso! {"type":"send message","cmd":"chat","to":"5511990283745@c.us","token":"WTIgtlBwDk4kJNv7oMMderfTWihceFm2mI9K","servidor":"res_winzap"}'
        )
      })
